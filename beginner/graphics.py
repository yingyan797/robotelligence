...
class Graphics:
    ...
    def __init__(self):
        # Screen dimensions
        self.screen = pygame.display.set_mode((2 * config.WINDOW_SIZE + constants.WINDOW_MARGIN, config.WINDOW_SIZE + constants.WINDOW_HEADER))
    ...
    def draw(self, environment, visualisation_lines, visualisation_circles):
        # Clear the screen
        ...
        self.draw_visualisation_lines(visualisation_lines, self.right_canvas)
        self.draw_visualisation_circles(visualisation_circles, self.right_canvas)
        self.draw_goal_state(environment, self.right_canvas)
    ...
    def draw_robot(self, environment, canvas):
        ...
        environment.get_joint_pos_from_state(environment.state)
        base_pos = self.world_pos_to_window_pos(environment.robot_base_pos)
        joint1_pos = self.world_pos_to_window_pos(environment.robot_joint_pos[0])
        joint2_pos = self.world_pos_to_window_pos(environment.robot_joint_pos[1])
        hand_pos = self.world_pos_to_window_pos(environment.robot_joint_pos[2])
    ...
    def draw_visualisation_circles(self, visualisation_circles, canvas):
