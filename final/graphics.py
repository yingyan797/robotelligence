...
class Graphics:
    ...
    def draw(self, environment, planning_visualisation_lines, policy_visualisation_lines):
        # Clear the screen
        ...
        self.draw_visualisation_lines(planning_visualisation_lines, policy_visualisation_lines)
    ...
    def draw_visualisation_lines(self, planning_visualisation_lines, policy_visualisation_lines):
        # Planning
